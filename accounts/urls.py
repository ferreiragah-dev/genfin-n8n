...
from .views import (
    ...
    VehicleDestinationCreateView,
    VehicleDestinationDetailView,
    VehicleDestinationListView,
    VehicleListView,
    VehicleSummaryView,
...
urlpatterns = [
    ...
    path("vehicle-destinations/", VehicleDestinationListView.as_view()),
    path("vehicle-destinations/create/", VehicleDestinationCreateView.as_view()),
    path("vehicle-destinations/<int:destination_id>/", VehicleDestinationDetailView.as_view()),
    path("vehicles/summary/", VehicleSummaryView.as_view()),
    path("trips/", TripPlanListView.as_view()),
    path("trips/create/", TripPlanCreateView.as_view()),
    path("trips/<int:trip_id>/", TripPlanDetailView.as_view()),
    path("trips/evaluate/", TripEvaluateView.as_view()),
